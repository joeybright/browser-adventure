...
/***/ function(module, exports, __webpack_require__) {
	...
	var Log = __webpack_require__(163)
	var Adventure = __webpack_require__(165)
	// styles
	var reset = __webpack_require__(169)
	var css = __webpack_require__(171)
	...
	var App = React.createClass({displayName: "App",
	  ...
	  render: function () {
	    return (
	      React.createElement("div", {className: "text-adventure", onClick: this.focusInput}, 
	        React.createElement(Log, {data: this.state}), 
	        React.createElement(Input, {onAdd: this.updateAdventure, focus: this.state.focus})
	      )
	    )
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Input = React.createClass({displayName: "Input",
	  ...
	  render: function () {
	    return (
	      React.createElement("input", {autofocus: true, type: "text", ref: "playerInput", className: "adventure-input", onKeyDown: this.handleChange}
	      )
	    )
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "input.adventure-input {\n  background: none;\n  border: 1px solid #efefef;\n  font-size: 18px;\n  font-family: \"Lucida Console\", monospace;\n  line-height: 1.5; }\n\ninput.adventure-input:focus {\n  outline: 0; }\n", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	// components/Log.jsx
	var React = __webpack_require__(1)
	var LogItem = __webpack_require__(164)
	...
	var Log = React.createClass({displayName: "Log",
	  ...
	  render: function () {
	    ...
	    var logNodes = this.props.data.log.map(function (data) {
	      return (
	        React.createElement(LogItem, {logText: data.text})
	      );
	    });
	    return (
	      React.createElement("div", {className: "adventure-log"}, 
	        logNodes
	      )
	    )
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var LogItem = React.createClass({displayName: "LogItem",
	  ...
	  render: function () {
	    // Currently just displays all of the data passed to it
	    return (
	      React.createElement("div", {className: "adventure-log-item"}, 
	        this.props.logText
	      )
	    )
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	// Adventure.jsx
	var AdventureData = __webpack_require__(166)
	var AdventureLog = __webpack_require__(167)
	var _ = __webpack_require__(168)
	//
	var currentPlayerId
	var currentLineId
	var expectedResponseLineIds

	var Adventure = ({

	  // When a line is passed
	  // addLineToLog: function(passedString) {
	  //  
	  // }
	  // Check to see if that line matches a line in the expected responses object
	  // If it doesn't print something else to the console (an error)

	  // If the line is an expected response
	  // Find the response to that line
	  // Print that response out to the view
	  // Set the variables of currentPlayerId, currentLineId, and expectedResponseLineIds
	  // Wait for a response
	  ...
	  startAdventure: function() {
	    ...
	    this.setCurrentPlayerId(firstLine.owner);
	  ...
	  setCurrentPlayerId: function(passedId) {
	    // Find players
	    // Check to see if the passed ID belongs to one of the players
	    // Otherwise, log an error to the console
	    return currentPlayer = passedId;
	  },
	  setExpectedResponseLineIds: function(passedId) {
	    // Find the current line
	    // ??
	    return expetedResponseLineIds = passedId;
	  },
	  addLineToLog: function(passedString) {
	    // Pushes the passed string into the adventure log
	    AdventureLog.log.push({text: passedString});
	    // Checks for any post-push updates on the line
	    this.checkForUpdate(passedString);
	    // Sets the current player to the player that is supposed to repond to the new line
	    this.setCurrentPlayerId(this.findLineByString(passedString).characterRespondingId);
	    this.setExpectedResponseLineIds(this.findLineByString(passedString).expectedResponseLineIds);
	    console.log(passedString);
	    console.log("Current Player Id: ", currentPlayerId);
	    console.log("Current Line Id: ", currentLineId);
	    console.log("Current Expected Response Id: ", expectedResponseLineIds);
	    // Returns the adventure log
	    return AdventureLog;
	  },
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../node_modules/css-loader/index.js!./../node_modules/sass-loader/index.js!./error.scss", function() {
				var newContent = require("!!./../node_modules/css-loader/index.js!./../node_modules/sass-loader/index.js!./error.scss");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
